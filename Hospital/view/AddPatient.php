...
require ($_SERVER['DOCUMENT_ROOT'].'/Hospital/controller/php-validation/AddPatientController.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="../view/css/AddPatient.css">
        ...
        <div class="bodydiv">
            ...
            <div class="right">
                ...
                <div class="right-left">
                   <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" name="apForm" method="POST" onsubmit="return isvalid()">
