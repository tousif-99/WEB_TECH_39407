...
require ($_SERVER['DOCUMENT_ROOT'].'/Hospital/model/DbRead.php');
     ...
     $fname=$lname=$gender=$dob=$phone=$userName=$password="";
     $successfulMessage=$errorMessage="";
     $fnameErr=$lnameErr=$dobErr=$genderErr=$phonNumberErr=$userNameErr=$passwordErr="";
     $flag=false;
     ...
     if($_SERVER['REQUEST_METHOD']=='POST')
            {
                ...
                if(!$flag)
                {
                    ...
                    $result=addPatient($fname, $lname, $gender,$phone, $dob, $userName, $password);
